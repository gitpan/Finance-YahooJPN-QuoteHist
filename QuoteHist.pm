...
our $VERSION = '0.02'; # 2003-08-12 (since 2001-05-30)
...
Finance::YahooJPN::QuoteHist - fetch histrical quotes of Japanese stock markets
...
=head1 SYNOPSIS
  ...
  my @quote = Finance::YahooJPN::QuoteHist->quotes('6758.t');
